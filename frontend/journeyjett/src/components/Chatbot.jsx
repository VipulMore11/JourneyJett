    ...
    <>
      <div className=' Chatbot flex rounded-lg' style={{ position: 'fixed', bottom: '80px', right: '50px', backgroundColor:'white' }}>
        <div className={` flex-col rounded-lg`} style={{ height: '500px', width: '400px', display: show ? 'block' : 'none', opacity: show ? 1 : 0, transition: 'opacity 0.3s ease-in-out' }}>
          <div className='bg-green-500 h-12 w-full flex justify-start items-center rounded-lg' >
          ...
          <div className='mx-4 my-2 border-2 rounded-lg border-black' style={{ position: 'absolute', bottom: '0', left: '0', right: '0', display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
            <input className='p-2 border-black w-full rounded-lg' onChange={handleInputChange} value={usermsg} type="text" placeholder='Ask Something....' />
